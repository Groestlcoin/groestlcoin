...
public:
    CMainParams() {
        ...
        chainTxData = ChainTxData{
            // Data from RPC: groestlcoin-cli getchaintxstats 4096 00000000000012d90cb55b1e1dd8c2ad3dfd01377339bcd3d5ff36f07365c5d9 | jq '{time,txcount,txrate}'
            .nTime    = 1775399323,
            .tx_count = 7604946,
            .dTxRate  = 0.01733947439718234,
        };
...
public:
    CTestNetParams() {
        ...
        chainTxData = ChainTxData{
            // Data from RPC: groestlcoin-cli -testnet getchaintxstats 4096 000000e75261a2e116d21333cf28c11e66711b7dd8d439b9ca19f69de565982c | jq '{time,txcount,txrate}'
            .nTime    = 1775399168,
            .tx_count = 4472009,
            .dTxRate  = 0.01046773653278114,
        };
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        if (!options.challenge) {
            ...
            consensus.nMinimumChainWork = uint256{"00000000000000000000000000000000000000000000000000000a597666af14"}; // groestlcoin-cli -signet getblockheader 0000001e31e60bd02a5914ef28ca8bd752c75794b37d6efe49b4d8433f0d09f7 | jq '{chainwork}'
            consensus.defaultAssumeValid = uint256{"0000001e31e60bd02a5914ef28ca8bd752c75794b37d6efe49b4d8433f0d09f7"}; // groestlcoin-cli -signet getblockhash 2245000
            ...
            chainTxData = ChainTxData{
                // Data from RPC: groestlcoin-cli -signet getchaintxstats 4096 0000001e31e60bd02a5914ef28ca8bd752c75794b37d6efe49b4d8433f0d09f7 | jq '{time,txcount,txrate}'
                .nTime    = 1775375415,
                .tx_count = 2245015,
                .dTxRate  = 0.01597242261408038,
            };
        } else {
