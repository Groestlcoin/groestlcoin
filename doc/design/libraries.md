...
| *libbitcoin_ipc*         | IPC functionality used by *groestlcoin-node*, *groestlcoin-wallet*, *groestlcoin-gui* executables to communicate when [`-DWITH_MULTIPROCESS=ON`](multiprocess.md) is used. |
