...
## Overview
In this tutorial we have two hosts, both running Groestlcoin v32.0
...
```sh
[offline]$ ./build/bin/groestlcoin-cli -signet -rpcwallet="offline_wallet" -named exportwatchonlywallet \
...
```sh
[online]$ ./build/bin/groestlcoin-cli -signet -named restorewallet \
