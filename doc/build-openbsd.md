...
Groestlcoin Core is supported on [the two most recent OpenBSD releases](https://www.openbsd.org/faq/faq5.html#Flavors).

This guide describes how to build groestlcoind, command-line utilities, and GUI on the latest release.
